...
Usage:          IAR: Drag the middleware/third_party/lzma_decoder folder to your project. Add middleware/third_party/lzma_decoder/inc to "additional include directories" in IAR options setting.
Dependency:     None. 
